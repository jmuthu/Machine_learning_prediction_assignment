...
The model that performed the best was Random forest and it had an accuracy of 0.9988 and Kappa of 0.9985 on independent testing dataset.
...
We can estimate the accuracy (1- out sample error) on the testing dataset to be around the mean of the sample accuracy which is 0.9987.
So lets predict on the testing dataset and check the accuracy and kappa metrics as shown below
```{r, cache=TRUE,echo=FALSE,message=FALSE}
